...
void SuperRm::clear(const std::string& name) {
...
void SuperRm::remove_file(const std::string& name, bool debug) {
...
void SuperRm::remove_folder(const std::string& name, bool debug) {
...
void SuperRm::remove_dir(const Directory& dir, bool debug_mode, bool recur) {
    switch (dir.get_type()) {
        case Directory::File:
            clear(dir.get_path());
...
void SuperRm::remove(int argc, char** argv) {
